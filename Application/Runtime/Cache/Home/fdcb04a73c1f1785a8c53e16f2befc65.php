...
<head>
<meta charset="utf-8">
<title>搜索结果-<?php echo ($tpshop_config['shop_info_store_title']); ?></title>
...
<div id="warpper" class="clearfix">
    ...
    <div class="item fl">
      ...
      <div class="fl" id="m-selected-cery">
        <div class="u-left-icon"><i class="z-arrow"></i></div>
          ...
          <div class="u-nav-title"> <a href="javascript:;"><?php echo ($filter_param['q']); ?><i></i></a>
  ...
  <div class="cata_cart_left">
    <div class="m-cart">
      <p class="title"><a href="<?php echo U("/Home/Goods/search",array('q'=>$filter_param['q']),'');?>">全部分类</a></p>
      <!--search/?q=-->
      <div id="cata_list"> 
        <!-- 分类树 -->
        <ul class="menu_3">
          <?php if(is_array($cateArr)): foreach($cateArr as $k=>$v): ?><li class="menu_two">            
            <a  href="<?php echo ($v["href"]); ?>" class="menu3_title"><?php echo ($v["name"]); ?></a>
